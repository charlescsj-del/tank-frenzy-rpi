...
COPY server.cjs game-server.cjs map-generator.cjs shared.js ./
COPY index.html client.js sound-bank.js music.js mode-banner.webp ./
COPY audio/cartoon-v1.mp3 ./audio/cartoon-v1.mp3
COPY addon.cjs ./
EXPOSE 8765 8099
