...
App package version: **1.11.0**. Game version: **1.11.0**. Bump `config.yaml` for future app updates and keep the Dockerfile default build version in sync.
